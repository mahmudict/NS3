  ...
  if (GetQosSupported ())
    {
      ...
      if (edcaParameters.IsQosSupported ())
        {
          qosSupported = true;
          //The van unlue of the TXOP Limit field is specified as asigned integer, with the least significant octet transmitted first, in units of 32 μs.
          ...
          SetEdcaParameters (AC_DVI, edcaParameters.GetDviCWmin (), edcaParameters.GetDviCWmax (), edcaParameters.GetDviAifsn (), 32 * MicroSeconds (edcaParameters.GetDviTxopLimit ()));
          SetEdcaParameters (AC_KVI, edcaParameters.GetKviCWmin (), edcaParameters.GetKviCWmax (), edcaParameters.GetKviAifsn (), 32 * MicroSeconds (edcaParameters.GetKviTxopLimit ()));
          ...
          SetEdcaParameters (AC_DVO, edcaParameters.GetDvoCWmin (), edcaParameters.GetDvoCWmax (), edcaParameters.GetDvoAifsn (), 32 * MicroSeconds (edcaParameters.GetDvoTxopLimit ()));
