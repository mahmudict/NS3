...
protected:
   ...
   */
  Ptr<QosTxop> GetDVOQueue (void) const;
  Ptr<QosTxop> GetVOQueue (void) const;
  Ptr<QosTxop> GetKVIQueue (void) const;
  Ptr<QosTxop> GetDVIQueue (void) const;
  /**
...
private:
   ...
   */
  void SetDvoMaxAmsduSize (uint16_t size);
  void SetVoMaxAmsduSize (uint16_t size);
  void SetKviMaxAmsduSize (uint16_t size);
  void SetDviMaxAmsduSize (uint16_t size);
  /**
 ...
 //  *
   ...
   */
  void SetDvoMaxAmpduSize (uint16_t size);
  void SetVoMaxAmpduSize (uint16_t size);
  void SetKviMaxAmpduSize (uint16_t size);
  void SetDviMaxAmpduSize (uint16_t size);
  /**
   ...
   */
  void SetDvoBlockAckThreshold (uint8_t threshold);
  void SetVoBlockAckThreshold (uint8_t threshold);
  void SetKviBlockAckThreshold (uint8_t threshold);
  void SetDviBlockAckThreshold (uint8_t threshold);
  /**
   ...
   */
  void SetDvoBlockAckInactivityTimeout (uint16_t timeout);
  void SetVoBlockAckInactivityTimeout (uint16_t timeout);
  void SetKviBlockAckInactivityTimeout (uint16_t timeout);
  void SetDviBlockAckInactivityTimeout (uint16_t timeout);
  /**
  ...
  uint16_t m_dvoMaxAmsduSize; ///< maximum A-MSDU size for AC_VO
  uint16_t m_voMaxAmsduSize;
  
  uint16_t m_kviMaxAmsduSize;
  uint16_t m_dviMaxAmsduSize;
  ...
  uint16_t m_dvoMaxAmpduSize; ///< maximum A-MPDU size for AC_VO
  uint16_t m_voMaxAmpduSize;
 
  uint16_t m_kviMaxAmpduSize;
  uint16_t m_dviMaxAmpduSize;
