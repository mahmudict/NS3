  ...
  if (GetQosSupported ())
    {
      ...
      edcaParameters.SetDviTxopLimit (static_cast<uint16_t> (txopLimit.GetMicroSeconds () / 32));
      ...
      edca = m_edca.find (AC_KVI)->second;
            ...
            edcaParameters.SetKviTxopLimit (static_cast<uint16_t> (txopLimit.GetMicroSeconds () / 32));
      ...
      edcaParameters.SetDvoTxopLimit (static_cast<uint16_t> (txopLimit.GetMicroSeconds () / 32));
